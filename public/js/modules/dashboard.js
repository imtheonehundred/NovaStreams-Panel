(function () {
  ...
  function createDashboardModule() {
    ...
    function updateDashboardFromWS(ctx, payload) {
    ...
    function handleWSEvent(ctx, data) {
      const eventLabels = {
    ...
    return {
      createInitialState: (createDashboardState) => createDashboardState(),
      dashboardFormatNumber,
      dashboardRelativeAge,
      loadDashboard,
      updateDashboardFromWS,
      handleWSEvent,
    };
  }
